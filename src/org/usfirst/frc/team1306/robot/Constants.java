...
public class Constants {
	...
	public final static double CUBETAKE_SPIT_TIME = 0.5; //Time it takes to autonomously spit cube, with extra just to be sure...
	public final static double CUBETAKE_COLLECT_TIME = 1.25; //Time it takes to autonomously collect cube, with extra just to be sure...
